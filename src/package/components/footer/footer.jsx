...
import { ReactComponent as Logo } from '../../assets/icons/brands/jpro.svg';
...
const FooterComponent = () => {
                    ...
                    <Tooltip
                        title={
                            <FormattedMessage
                                ...
                                defaultMessage="See more projects cathing my interest!"
                            />
                        }
                    >
                        <a
                            className={classes.githubLink}
                            href="https://github.com/l1kw1d"
                            target="_bank"
    ...
    return (
        <div className={classes.container}>
            <a className={classes.logoLink} href="https://jprovo.st" target="_blank" rel="noreferrer noopener">
                <Logo className={classes.logo} />
            </a>
            <ShareLinks />
            <Tooltip
                title={
                    <FormattedMessage id="Footer.github.tooltip" defaultMessage="See more project catching my interests!" />
                }
            >
                <a
                    className={classes.githubLink}
